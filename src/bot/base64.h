...
class base64 {
 public:
  ...
  static bool encode(const char *input, size_t input_length, char *out, size_t out_length) {
    ...
    size_t encoded_length_ = encoded_length(input_length);
  ...
  static bool decode(const char *input, size_t input_length, char *out, size_t out_length) {
    ...
    size_t decoded_length_ = decoded_length(input, input_length);
  ...
  static size_t decoded_length(const char *in, size_t in_length) {
    int numEq = 0;
  ...
  static size_t decoded_length(const std::string &in) {
    int numEq = 0;
    size_t n = in.size();
  ...
  inline static size_t encoded_length(size_t length) {
    return (length + 2 - ((length + 2) % 3)) / 3 * 4;
  }

  inline static size_t encoded_length(const std::string &in) {
    return encoded_length(in.length());
  }

  inline static void strip_padding(std::string *in) {
